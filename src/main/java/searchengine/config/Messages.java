...
public class Messages {
    public final static String INDEXING_HAS_ALREADY_STARTED = "Индексация уже запущена";
    public final static String INDEXING_STOPPED_BY_USER = "Индексация остановлена пользователем";
